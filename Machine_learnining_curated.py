...
AmazonS3_node1745309050339 = glueContext.getSink(path="s3://stedi-human/step_trainer/curated/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="AmazonS3_node1745309050339")
