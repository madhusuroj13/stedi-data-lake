...
'''
SQLQuery_node1745300617534 = sparkSqlQuery(glueContext, query = SqlQuery582, mapping = {"myDataSource":Join_node1745299854842}, transformation_ctx = "SQLQuery_node1745300607534")
...
AmazonS3_node1745300076508 = glueContext.getSink(path="s3://stedi-human/accelerometer/trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="AmazonS3_node1745300076508")
